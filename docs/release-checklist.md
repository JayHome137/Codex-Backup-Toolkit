...
- [ ] Release 标题使用中文，例如：`Codex-Backup-toolkit v0.30.0` 可以保留项目名和版本号，但说明正文只写中文。
...
- [ ] 说明 GitHub Actions 已加入 Windows runner 原生验证，但 Windows 安装包构建仍待完成。
- [ ] 说明 Windows 安装包构建、SMB/WebDAV/rclone 原生验证和真实恢复执行仍待完成。
